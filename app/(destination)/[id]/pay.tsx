...
export default function PayPage() {
  const { bookingId, title, type } = useLocalSearchParams<{
    bookingId: string;
    title: string;
    type: string;
  }>();
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      router.push(
        `/booking-success?type=${encodeURIComponent(
          type || "destination"
    ...
    <View style={styles.wrapper}>
      ...
      >
        ...
        <Text style={styles.note}>
          Once submitted, your booking will be reviewed. You’ll get a receipt via
